...
{
    /// <summary>
    /// Adapter for Eto Font object for core.
    /// </summary>
    internal sealed class FontAdapter : RFont
    {
        ...
        public override double Height => _height ?? (_height = GetHeight()).Value;

        float GetHeight() => _font.LineHeight;

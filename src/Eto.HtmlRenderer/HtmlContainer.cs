...
namespace TheArtOfDev.HtmlRenderer.Eto
{
    ...
    /// <see cref="HtmlPanel"/> and <see cref="HtmlRender"/>.<br/>
    /// </summary>
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {
            return new RMouseEvent(e.Buttons.HasFlag(MouseButtons.Primary));
        }
        ...
        {
            var commonDown = e.Modifiers.HasFlag(Application.Instance.CommonModifier);
            return new RKeyEvent(commonDown, e.Key == Keys.A, e.Key == Keys.C);
        }

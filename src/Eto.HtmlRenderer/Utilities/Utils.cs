...
{
    /// <summary>
    /// Utilities for converting Eto entities to HtmlRenderer core entities.
    /// </summary>
    internal static class Utils
    {
        /// <summary>
        /// Convert from Eto point to core point.
        /// </summary>
        ...
        /// <summary>
        /// Convert from core point to Eto point.
        /// </summary>
        ...
        /// <summary>
        /// Convert from Eto size to core size.
        /// </summary>
        ...
        /// <summary>
        /// Convert from core size to Eto size.
        /// </summary>
        ...
        /// <summary>
        /// Convert from Eto rectangle to core rectangle.
        /// </summary>
        ...
        /// <summary>
        /// Convert from core color to Eto color.
        /// </summary>
        ...
        {
            return new Graphics(new Bitmap(1, 1, PixelFormat.Format32bppRgba));
        }
    }
}